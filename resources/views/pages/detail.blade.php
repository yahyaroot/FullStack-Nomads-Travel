            ...
            <div class="card card-details">
              ...
              <div class="gallery">
                <div class="xzoom-container">
                  <img src="./frontend/image/details.jpg" alt="details" class="xzoom" id="xzoom-default"
                    xoriginal="./frontend/image/details.jpg">
                </div>
                <div class="xzoom-thumbs">
                  <a href="./frontend/image/details.jpg">
                    <img src="./frontend/image/details.jpg" class="xzoom-gallery" width="128"
                      xpreview="./frontend/image/details.jpg">
                  </a>
              ...
              <div class="features row">
                <div class="col-md-4">
                  <img src="./frontend/image/ic_event.png" class="features-image" alt="" />
                ...
                <div class="col-md-4 border-left">
                  <img src="./frontend/image/ic_language.png" class="features-image" alt="" />
                  <div class="description">
                    <h3>Language</h3>
                ...
                <div class="col-md-4 border-left">
                  <img src="./frontend/image/ic_foods.png" class="features-image" alt="" />
                  <div class="description">
                    <h3>Foods</h3>
                    <p>Local Foods</p>
                  </div>
